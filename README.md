...
* For the source code of the brainnet package itself: this is WIP and we have not decided on a license yet: this software has [no license](https://choosealicense.com/no-permission/) at this time.
